    ...
    <ClerkProvider
      ...
      localization={{
        signIn: {
          start: {
            title: "Welcome back",
            subtitle: "Sign in to continue your Basic Revenue Management & Pricing Analytics course",
          },
        },
        signUp: {
          start: {
            title: "Create your account",
            subtitle: "Start your revenue management & pricing analytics journey with Basic Revenue Management & Pricing Analytics",
          },
        },
      }}
