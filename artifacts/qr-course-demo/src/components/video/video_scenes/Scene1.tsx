    ...
    >
      <AnimatePresence mode="wait">
        {phase < 2 ? (
          ...
          >
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Financial &amp; Managerial Analytics</h1>
              ...
              <div className="col-span-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <h4 className="font-serif text-lg mb-2">How a Business Works</h4>
          ...
          >
            ...
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Unit 1 — How a Business Works</h1>
              ...
              <div className="divide-y divide-border">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="font-medium">1.1 What financial &amp; managerial analytics is</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.2 Reading the score: the three financial statements</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.3 Where the money goes: cost behavior</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.5 Budgets and variance</span>
                  </div>
